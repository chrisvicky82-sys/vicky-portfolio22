  ...
  return (
    <div className="fixed top-0 left-0 w-full h-screen pointer-events-none z-10 flex flex-col justify-center items-center">
      ...
      <motion.div 
        ...
        className="absolute left-4 md:left-20 lg:left-32 top-[85%] md:top-[45%] -translate-y-1/2 z-20 pointer-events-auto"
      >
      ...
      <motion.div 
        style={{ opacity: iconOpacity, y: iconY }}
        className="absolute right-4 md:right-20 lg:right-32 top-[85%] md:top-[45%] -translate-y-1/2 z-20 pointer-events-auto"
      >
